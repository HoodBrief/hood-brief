...
P1_PATTERNS = [
    ...
    r'\bdeath\b', r'\bdeath\s+call\b', r'\bfound\s+dead\b',
    r'\bhandgun\b', r'\bpistol\b', r'\brevolver\b', r'\bfirearm\w*\b',
    r'\bshotgun\b', r'\brifle\b',
...
P2_PATTERNS = [
    ...
    r'\bdisturbance\b', r'\bdisorderly\b',
    r'\bhomeless\b', r'\bvagrant\b', r'\btransient\b',
    r'\bmotion\b', r'\bsurveillance\b', r'\bcamera\b',
    r'\breported\s+taken\b', r'\bflight\s+call\b',
    r'\bdisturbing\s+customers\b', r'\bdisturbing\s+\w+\b',
    r'\bsuspicious\s+person\b', r'\bsuspicious\s+vehicle\b',
    r'\bcheck\s+on\b', r'\bwelfare\b',
    r'\bproperty\s+damage\b', r'\breporting\s+a\b',
    r'\bcriminal\s+trespass\b',
    r'\bunwanted\s+person\b', r'\bunwanted\s+subject\b',
    r'\btraffic\s+stop\b', r'\bpullover\b', r'\bpull\s+over\b',
    r'\bwarrant\w*\b',
    r'\balarm\b',
    r'\barguing\b', r'\bargument\b',
    r'\bfight\b', r'\bfighting\b',
    r'\bhang\s+call\b', r'\bopen\s+line\b',
    r'\bmissing\b',
    r'\bjuvenile\b', r'\bminor\b',
    r'\bbolo\b', r'\blook\s+out\s+for\b',
    r'\bopen\s+mic\b',
    r'\bwound\w*\b',
    r'\bshot\s+at\b',
    r'\bin\s+custody\b',
    r'\bbeing\s+chased\b', r'\bchased\s+by\b',
    ...
    r'\bintoxicated\b', r'\btask\s+force\b',
...
TITLE_MAP = [
    ...
    ('death call',          'Death Investigation'),
    ('found dead',          'Deceased Person'),
    ('handgun',             'Weapons Call'),
    ('pistol',              'Weapons Call'),
    ('firearm',             'Weapons Call'),
